...
public class GameBoard extends SimpleApplication { 
    ...
    private static Geometry ceiling;
    ...
    public void createBoard() {
        ...
        ceiling = makeFace("Ceiling", x, z);
        ceiling.move(0f+xOffset, y+2, 0f);
        ...
        ceiling.addControl(ceiling_phy);
    ...
    public void simpleInitApp() {
        ...
        */
        ...
        bulletAppState.getPhysicsSpace().setAccuracy(1f/120f);       //Increase physics accuracy, to be tweaked later
    ...
    //Remove projectiles and particles generated by explosives
    public void removeExplosiveEffects() {
        ...
        for (int i=0; i<detonatedTime.size(); i++)
            if (System.currentTimeMillis() - detonatedTime.get(i) > 1000) {  //If more than 2 seconds has elapsed, remove corresponding projectiles
                detonatedList.get(i).removeEffects();
            }
    }
    
    //Remove projectiles and particles generated by blocks
    public void removeBlockEffects() {
        for (int i=0; i<blockParticleTime.size(); i++)
            if (System.currentTimeMillis() - blockParticleTime.get(i) > 1000) {  //If more than 2 seconds has elapsed, remove corresponding projectiles
                blockParticleList.get(i).removeEffects();                
            }
    }
